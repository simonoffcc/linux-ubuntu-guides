...
3. `sudo apt-get install git fakeroot build-essential ncurses-dev xz-utils libssl-dev bc flex libelf-dev bison`
    - ![Packages](https://github.com/simonoffcc/linux-ubuntu-guides/raw/main/images/1_packages.png)
...
1. `sudo nano .config`
    ...
    **Результат:** `87m38,402s` - 5258 секунд
        - ![begin](https://github.com/simonoffcc/linux-ubuntu-guides/raw/main/images/4_Screenshot.png)
        - ![end](https://github.com/simonoffcc/linux-ubuntu-guides/raw/main/images/5_Screenshot.png)
